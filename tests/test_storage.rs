// This file tests the Storage trait implementation directly at the Rust library level
// It tests the core storage functionality without going through HTTP API
// Complementary to test_storage_python.py which tests the HTTP API endpoints
