// This file tests S3Storage implementation directly at the Rust library level
// It tests direct S3 integration without going through HTTP API
// Complementary to test_s3_storage_python.py which tests the HTTP API endpoints
